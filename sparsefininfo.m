function Data = sparsefininfo(filename)
%SPARSEFININFO Reads header data from a binary charter file
%
% Data = fininfo(filename)
%
% This program reads the header data from a .fin file (also known as a
% binary charter file).  It also calculates the density of the data grid.
%
% Input variables:
%
...
%
%               dataDensity:    density of data, non-null/total 
...
Data.dataDensity = ngood/(Data.height*Data.width);
