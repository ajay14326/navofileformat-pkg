function Data = unisipsinfo(filename)
%UNISIPSINFO Reads header data from a unisips file
%
% Data = unisipsinfo(filename)
%
% This function reads in the information stored in a unisips file header
% and record headers and stores it in the structure Data. 
%
% Input variables:
%
...
for irec = 1:FileHeader.rows
    ...
    RecordHeader.layback(irec)   = fread(fid, 1, 'ushort', 'b');
    ...
    RecordHeader.towDepth(irec) = fread(fid, 1, 'float', FileHeader.cols, 'b');
